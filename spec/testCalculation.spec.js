...
describe("Functions", function () {
    ...
    describe('Other', () => {
        ...
        itParam("Should throw exception: onTempChange", [undefined, {}, { payload: true }, { payload: '' }, { payload: function () { } }], (val) => {
            should(function () {
                hc.onTempChange(val);
        ...
        itParam("Should throw exception: constructor", [undefined, 1, { test: 1 }, { group: 1 }, { group: true }], (val) => {
            ...
            should(function () {
                ...
                // }
                // heat.prototype.getFrontModule = sinon.fake.returns({
                //     getHTML: sinon.fake.returns('<html></html>')
                // });
                // RED.require.returns()
                new heat(RED, val);
